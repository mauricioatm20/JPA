...
//	esta relacion es uno a muchos de un contacto a muchos telefonos y lo llama elementcollection
	@ElementCollection()
	@CollectionTable(name = "telefonos", joinColumns = {@JoinColumn(name ="fk_contacto")})
//	@joinColums espera un array de anotaciones @joinColum y pondremos tantas como formen la FK. la fk_.. que apunta a nuestra tabla superior
