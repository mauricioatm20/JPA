...
@Embeddable // esta clase es insertable
public class Dni06 implements Serializable {

	public int nroDni;
	public char letraDni;
	
//	jpa dice que el standar que tiene que manipular deben cumpli el standar Javabean
	public Dni06() {}
	...
	public String toString() {
		return "Dni05 [nroDni=" + nroDni + ", letraDni=" + letraDni + "]";
	}
